...
contract RebaseToken is ERC20,Ownable,AccessControl{
    ...
    mapping (address => uint) s_userIntrestRate;
    mapping (address => uint) s_userLastPriceTimestamp;
     ...
     */
    function _calculateUserAccumulatedInterestSinceLastUpdate(address _user) internal view returns(uint256 lineraIntrestFactor){
